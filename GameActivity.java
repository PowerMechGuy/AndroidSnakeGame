package com.apparatus.snake.app;
	...
	class SnakeView extends SurfaceView implements Runnable
		    ...
		    {     
				...
				try 
				    {     
						...
						descriptor = assetManager.openFd("snake1.ogg");
						sample1 = soundPool.load(descriptor, 0);
						descriptor = assetManager.openFd("snake2.ogg"); 
						sample2 = soundPool.load(descriptor, 0);
						descriptor = assetManager.openFd("snake3.ogg"); 
						sample3 = soundPool.load(descriptor, 0);
						descriptor = assetManager.openFd("snake4.ogg");
		...
		public void configureDisplay()
		    {      
				...
				bodyBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.snake_body);
